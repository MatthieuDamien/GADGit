...
Commentaires:
- Voir si on peut améliorer la gestion des erreurs lors du lancement des analyses.
- :172-173 - ajoute un événement après le lancement, mais si le lancement échoue, l'événement est quand même créé. Ordre incorrect.
"""
